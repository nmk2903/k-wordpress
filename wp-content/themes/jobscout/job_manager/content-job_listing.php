...
$created_time = get_post_time('M d, Y', false, get_the_ID(), true);
$categories = wp_get_post_terms(get_the_ID(), '_job_category',true);
$job_post = get_post();

// Lấy mô tả ngắn của công việc
$job_description = $job_post->post_content;
