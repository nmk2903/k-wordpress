...
<nav id="site-navigation" class="main-navigation" role="navigation" itemscope
    ...
    <button class="toggle-btn" data-toggle-target=".main-menu-modal" data-toggle-body-class="showing-main-menu-modal"
        aria-expanded="false" data-set-focus=".close-main-nav-toggle">
...
<<?php echo $tag ?> <?php comment_class(empty($args['has_children']) ? '' : 'parent') ?>
    ...
    <article id="div-comment-<?php comment_ID() ?>" class="comment-body" itemscope
            ...
            <div class="comment-metadata commentmetadata">
                <a href="<?php echo esc_url(htmlspecialchars(get_comment_link($comment->comment_ID))); ?>">
                    <time itemprop="commentTime"
                        datetime="<?php echo esc_attr(get_gmt_from_date(get_comment_date() . get_comment_time(), 'Y-m-d H:i:s')); ?>"><?php printf(esc_html__('%1$s at %2$s', 'jobscout'), get_comment_date(),  get_comment_time()); ?></time>
                </a>
            </div>
            <?php if ($comment->comment_approved == '0') : ?>
            <em
                class="comment-awaiting-moderation"><?php _e('Your comment is awaiting moderation.', 'jobscout'); ?></em>
            <br />
            <?php endif; ?>
        </footer>
    ...
    <div class="svg-holder">
        <svg class="fallback-svg"
            ...
            <rect width="<?php echo esc_attr($image_size['width']); ?>"
                height="<?php echo esc_attr($image_size['height']); ?>" style="fill:#f0f0f0;"></rect>
        </svg>
    </div>
    <?php
            }
